...
export default function SignUpPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      // In a real app, you would redirect to dashboard or verification page after successful registration
    }, 1500)
  }
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Join DIUQbank to access and share exam question papers
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                required
              />
              <p className="text-xs text-gray-500 dark:text-gray-500">This will be displayed on your contributions</p>
            </div>
            ...
            <div className="flex items-start">
              <Checkbox
                id="terms"
                className="border-red-300 dark:border-red-700 data-[state=checked]:bg-red-600 mt-1"
              />
